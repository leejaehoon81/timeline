...
requirejs.config({
    ...
    paths: {
        ...
        'leanmodal' : 'lib/jquery.leanModal.min',
        'flip': 'lib/flip',
        'facebooklogin': 'lib/facebooklogin',
        'init': 'lib/init',
        'hide': 'lib/hide',
        'jquery.dropotron.min': 'lib/jquery.dropotron.min',
        'jquery.scrollgress.min': 'lib/jquery.scrollgress.min',
        'skel': 'lib/skel.min',
        'util': 'lib/util',
        'main': 'lib/main'
    }

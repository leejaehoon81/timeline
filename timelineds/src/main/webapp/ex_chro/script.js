$(document).ready(function(){
	...
	main.width(Math.min(400,$(document).width()));
  /*main.height(Math.min(300,$(document).height())*/
  
	
	// Creating an array with four possible backgrounds and their sizes:
	
	var pics = new Array(						 
							{ url:'http://farm4.static.flickr.com/3595/3405361333_77f2a5e731_b.jpg', size:{x:512,y:384}},
							{ url:'http://farm4.static.flickr.com/3028/2753126743_4249a4e948_b.jpg', size:{x:512,y:384}},
							{ url:'http://farm4.static.flickr.com/3641/3595250019_5a1237899a_b.jpg', size:{x:512,y:384}},
							{ url:'http://farm3.static.flickr.com/2592/4018062274_1f7f23597d_o.jpg', size:{x:512,y:384}}
	);
	...
	function shoot(position){
		...
		var newShot = $('<div class="shot">').width(50).height(50);
